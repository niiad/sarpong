package com.example.micbeninventory.controller;
// Name: Michael Bneyah
//   ID: 10690389
...
public class JavaInventoryManagementSystem {
    public static void main(String[] args) {
        ...
        vendorProducts.put("P1", new Item("DoughNuts", 1.49, ItemCategory.BreadBakery));
        ...
        vendorProducts.put("P1", new Item("SpringRolls", 1.49, ItemCategory.BreadBakery));
        vendorProducts.put("P1", new Item("Meatpie", 1.49, ItemCategory.BreadBakery));
        vendorProducts.put("P1", new Item("Cupcakes", 1.49, ItemCategory.BreadBakery));
        vendorProducts.put("P1", new Item("Ketchup", 1.49, ItemCategory.CannedJarredGoods));
        vendorProducts.put("P1", new Item("Baked beans", 1.49, ItemCategory.CannedJarredGoods));
        vendorProducts.put("P1", new Item("ReadyToGo", 1.49, ItemCategory.CannedJarredGoods));
        vendorProducts.put("P1", new Item("Sealed Fruit Salad", 1.49, ItemCategory.CannedJarredGoods));
        vendorProducts.put("P1", new Item("Creamed Corn", 1.49, ItemCategory.CannedJarredGoods));
        vendorProducts.put("P1", new Item("Cheese", 1.49, ItemCategory.DairyProducts));
